...
export default function Retrieval({ onNavigate }) {
  ...
  async function handleRetrieve() {
    ...
    try {
      const res = await fetch(`/api/invoice/retrieve/${invoiceId.trim()}`);
    ...
    <div style={styles.page}>
      ...
      <nav style={styles.nav}>
        ...
        <div style={styles.navLinks}>
          <span className="nav-link" style={{ ...styles.navLink, ...styles.navLinkActive }}>Retrieve</span>
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>Enter your invoice ID to look up its details.</p>
            ...
            <div style={styles.resultCard}>
              ...
              <div style={styles.fieldGrid}>
                ...
                <div style={styles.field}>
                  ...
                  <span style={styles.fieldValue}>{result.userId}</span>
                </div>
              </div>
              <div style={styles.field}>
...
const styles = {
  ...
  statusBadge: { padding: '4px 12px', borderRadius: 999, fontSize: '0.8rem', fontWeight: 500, textTransform: 'capitalize' },
